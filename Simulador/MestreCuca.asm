...
ImprimeHambuger:
	...
	push r1
	push r2
		loadn r0, #2876 ; " pao_cima"
		loadn r1, #992 ; linha 440
		loadn r2, #40 ;proxima linha
		outchar r0, r1
    add r1, r1, r2
    loadn r0, #317 ; " hamburguer"
    outchar r0, r1
    add r1, r1, r2
    loadn r0, #2878 ; " pao_baixo"
    outchar r0, r1
	pop r2
	pop r1
	pop r0
